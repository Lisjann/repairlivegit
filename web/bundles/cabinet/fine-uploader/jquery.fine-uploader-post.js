        ...
        qq.basePrivateApi = {
            _addCannedFile: function(sessionData) {
                ...
                if (sessionData.thumbnailUrl) {
					...
					//$('').live('click', function(){
					$('#fine-uploader-gallery').on('click', 'li.qq-file-id-'+id+' img', function(){
						tinymce.execCommand('mceInsertContent',false,'<br/><div itemtype="http://schema.org/ImageObject" itemscope="" class="img"><img src="' + sessionData.thumbnailUrl + '" alt="" width="100%" itemprop="image" caption="false" /><p itemprop="description">Подпись к картинке</p></div><br/>');return false;
					});
                }
                this._netUploaded++;
...
//------------КОСТЫЛЬ ЧТОБЫ ПРИ КЛИКЕ НА КАРТИНКУ ОНА ВСТАВЛЯЛААСЬ В РЕДАКТИРУЕМОМ БЛОКЕ ПРИ ЗАГРУЗКЕ НОВЫХ КАРТИНОК-----------------
			...
			$('#fine-uploader-gallery').on('click', 'li.qq-file-id-'+id+' img', function(){
				tinymce.execCommand('mceInsertContent',false,'<br/><div itemtype="http://schema.org/ImageObject" itemscope="" class="img"><img src="/' + response.terget + '" alt="" width="100%" itemprop="image" caption="false" /><p itemprop="description">Подпись к картинке</p></div><br/>');return false;
			});
            return {
...
/*$('li.qq-file-id-'+id+' img').live('click', function(){
$('#fine-uploader-gallery').on('click', 'li.qq-file-id-'+id+' img', function(){
	tinymce.execCommand('mceInsertContent',false,'<div itemtype="http://schema.org/ImageObject" itemscope="" class="img"><img src="' + thumbnailUrl + '" alt="" width="765" itemprop="image" caption="false" /><p itemprop="description">Подпись к картинке</p></div><br/>');return false;
});*/
