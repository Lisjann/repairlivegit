...
*/
tinymce.PluginManager.requireLangPack('cite');
tinymce.PluginManager.add('cite', function(editor) {
	...
	function showDialog() {
		...
		editor.windowManager.open({
			...
			onsubmit: function(e) {
				...
				editor.insertContent('<p class="quote">'+author+quote+'</p>', {format: 'raw'});
