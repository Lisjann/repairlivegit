...
tinymce.PluginManager.add('imagedesc', function(editor) {
	...
	function showDialog(imageList) {
		...
		function onSubmitForm() {
			...
			editor.undoManager.transact(function() {
				...
				if (!imgElm) {
					...
					editor.selection.setContent( dom.createHTML(
													'div',
													dataDiv,
													dom.createHTML('img', data) + dom.createHTML('p', dataDivP, dataDivPText)
												 )
												);
		...
		generalFormItems.push({name: 'shemap', type: 'textbox', label: 'Подпись к изображению'});
